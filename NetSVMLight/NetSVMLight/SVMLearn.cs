...
namespace NetSVMLight
{
    ...
    public class SVMLearn
    {
        ...
        public void ExecuteLearner(String svmLearnPath, String trainingFile, String modelFile, String logFile, bool silent)
        {
            ...
            Process svmLearnProcess = CreateLearnerProcess(svmLearnPath, trainingFile, modelFile);
        ...
        /// <returns></returns>
        private Process CreateLearnerProcess(String svmLearnPath, String trainingFile, String modelFile)
        {
            Process svmLearnProcess = new Process();
            svmLearnProcess.StartInfo.FileName = svmLearnPath;

            StringBuilder svmLearnArgs = SetLearnerParams(trainingFile, modelFile);
